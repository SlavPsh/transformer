...
class SmallFlexSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        #y_scaled = F.scaled_dot_product_attention(query, key, value, attn_mask=None, dropout_p=dropout, is_causal=is_causal)
        y = flex_attention(query, key, value)
